...
v0.new("<Color=Cyan>Welcome to Script Khiem<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(92224140444451) ;
...
v8.Image = "rbxassetid://77752059530605";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Script Khiem",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=92224140444451&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
